...
require_once __DIR__ . '/../../classes/errors/ProductError.php';
...
if (empty($productName)) {
    redirect(__DIR__ . '/../../page/add-category.php?error=' . ProductError::NAME_REQUIRED);
}
if (empty($productPrice)) {
    redirect(__DIR__ . '/../../page/add-category.php?error=' . ProductError::PRICE_REQUIRED);
}
if (empty($productCover)) {
    redirect(__DIR__ . '/../../page/add-category.php?error=' . ProductError::COVER_REQUIRED);
}
if (empty($productDescription)) {
    redirect(__DIR__ . '/../../page/add-category.php?error=' . ProductError::DESCRIPTION_REQUIRED);
}
...
redirect('/php_store/php_store/page/products.php');
